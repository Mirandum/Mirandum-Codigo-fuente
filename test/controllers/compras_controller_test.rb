...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { fechaSolicitada: @compra.fechaSolicitada, pagada: @compra.pagada, precioTotal: @compra.precioTotal } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { fechaSolicitada: @compra.fechaSolicitada, pagada: @compra.pagada, precioTotal: @compra.precioTotal } }
